#include <Arduino.h>
#define VF "Serega88kos/BigClock@3.5"  // версия прошивки
//////////// НАСТРОЙКИ ////////////
...
struct Clck {
  ...
  bool enableAnimation = false;           // Включить анимацию
  uint16_t animationSpeed = 500;          // Длительность анимации в мс
  bool celsius = 0;                       // символ Цельсия "C"
};
Clck c;
...
struct Settings {
  ...
  bool rndTemp = false;         // округление температуры
};
Settings s;
/////////////////// КОНЕЦ НАСТРОЕК /////////////////